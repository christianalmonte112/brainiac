  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-40 rounded-full bg-slate-900 px-4 py-3 text-sm font-medium text-white shadow-lg transition-colors hover:bg-slate-800"
      >
        Feedback
      </button>
    );
