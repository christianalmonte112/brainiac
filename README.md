...
# Google Cloud Vision (accurate photo OCR — first 1k images/month free)
GOOGLE_CLOUD_VISION_API_KEY=...

# ElevenLabs (voice reader + voice summarization)
ELEVENLABS_API_KEY=...

# Stripe (subscription billing — test mode keys to start)
...
# Clerk webhook (syncs a User row the moment someone signs up; enforces beta invites)
CLERK_WEBHOOK_SECRET=whsec_...

# Admin (F-019) — Clerk userId of the app owner; gates /admin/* and the Admin nav link
ADMIN_USER_ID=user_...

# Upstash Redis (rate limiting on AI/voice/feedback routes — free tier is plenty)
